...
/* harmony import */ var _files_views_trashbinView_ts__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../files_views/trashbinView.ts */ "./apps/files_trashbin/src/files_views/trashbinView.ts");
/* harmony import */ var _files_src_logger_ts__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../../../files/src/logger.ts */ "./apps/files/src/logger.ts");
/**
 * SPDX-FileCopyrightText: 2023 Nextcloud GmbH and Nextcloud contributors
 * SPDX-License-Identifier: AGPL-3.0-or-later
 */
...
const restoreAction = new _nextcloud_files__WEBPACK_IMPORTED_MODULE_2__.FileAction({
  id: 'restore',
  displayName() {
    return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_3__.t)('files_trashbin', 'Restore');
  },
  iconSvgInline: () => _mdi_svg_svg_history_svg_raw__WEBPACK_IMPORTED_MODULE_7__,
  enabled(nodes, view) {
    // Only available in the trashbin view
    if (view.id !== _files_views_trashbinView_ts__WEBPACK_IMPORTED_MODULE_8__.TRASHBIN_VIEW_ID) {
      return false;
    }
    // Only available if all nodes have read permission
    return nodes.length > 0 && nodes.map(node => node.permissions).every(permission => Boolean(permission & _nextcloud_files__WEBPACK_IMPORTED_MODULE_2__.Permission.READ));
  },
  async exec(node) {
    try {
      const destination = (0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_5__.generateRemoteUrl)((0,_nextcloud_paths__WEBPACK_IMPORTED_MODULE_4__.encodePath)(`dav/trashbin/${(0,_nextcloud_auth__WEBPACK_IMPORTED_MODULE_0__.getCurrentUser)().uid}/restore/${node.basename}`));
      ...
      (0,_nextcloud_event_bus__WEBPACK_IMPORTED_MODULE_1__.emit)('files:node:deleted', node);
      return true;
    } catch (error) {
      _files_src_logger_ts__WEBPACK_IMPORTED_MODULE_9__["default"].error('Failed to restore node', {
        error,
        node
      });
      return false;
...
/******/ })()
;
//# sourceMappingURL=files_trashbin-init.js.map?v=0eba507c4d9d21b56e10