"use strict";
(self["webpackChunknextcloud"] = self["webpackChunknextcloud"] || []).push([["node_modules_nextcloud_upload_dist_chunks_InvalidFilenameDialog-C5Nkvs4v_mjs"],{
...
/***/ "./node_modules/@nextcloud/upload/dist/chunks/InvalidFilenameDialog-C5Nkvs4v.mjs":
/*!***************************************************************************************!*\
  !*** ./node_modules/@nextcloud/upload/dist/chunks/InvalidFilenameDialog-C5Nkvs4v.mjs ***!
  \***************************************************************************************/
...
/* harmony import */ var _index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./index-DAnggv92.mjs */ "./node_modules/@nextcloud/upload/dist/chunks/index-DAnggv92.mjs");
...
const _sfc_main = (0,vue__WEBPACK_IMPORTED_MODULE_6__.defineComponent)({
  ...
  setup() {
    return {
      t: _index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_2__.t
    };
  },
  data() {
    return {
  ...
  computed: {
    ...
    dialogButtons() {
      const buttons = [
        {
          label: (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_2__.t)("Cancel"),
          type: "error",
          callback: () => {
        ...
        {
          label: (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_2__.t)("Skip"),
          callback: () => {
      ...
      if (this.canRename) {
        buttons.push({
          label: (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_2__.t)("Rename"),
          type: "primary",
    ...
    getErrorText(error) {
      switch (error.reason) {
        case _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.InvalidFilenameErrorReason.Character:
          return (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_2__.t)('"{segment}" is not allowed inside a file or folder name.', { segment: error.segment });
        case _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.InvalidFilenameErrorReason.ReservedName:
          return (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_2__.t)('"{segment}" is a forbidden file or folder name.', { segment: error.segment });
        case _nextcloud_files__WEBPACK_IMPORTED_MODULE_1__.InvalidFilenameErrorReason.Extension:
          return error.segment.match(/\.\w/) ? (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_2__.t)('"{segment}" is a forbidden file type.', { segment: error.segment }) : (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_2__.t)('Filenames must not end with "{segment}".', { segment: error.segment });
      }
    }
  }
});
...
var __component__ = /* @__PURE__ */ (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_2__.n)(
  _sfc_main,
  _sfc_render,
...
//# sourceMappingURL=node_modules_nextcloud_upload_dist_chunks_InvalidFilenameDialog-C5Nkvs4v_mjs-node_modules_nextcloud_upload_dist_chunks_InvalidFilenameDialog-C5Nkvs4v_mjs.js.map?v=6e2e98825dd0cd9dce5a