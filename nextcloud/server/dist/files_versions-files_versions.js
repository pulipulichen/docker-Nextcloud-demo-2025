...
/* harmony import */ var _nextcloud_vue_components_NcDateTime__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! @nextcloud/vue/components/NcDateTime */ "./node_modules/@nextcloud/vue/dist/Components/NcDateTime.mjs");
/* harmony import */ var _nextcloud_vue_components_NcListItem__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! @nextcloud/vue/components/NcListItem */ "./node_modules/@nextcloud/vue/dist/Components/NcListItem.mjs");
/* harmony import */ var _nextcloud_vue_directives_Tooltip__WEBPACK_IMPORTED_MODULE_11__ = __webpack_require__(/*! @nextcloud/vue/directives/Tooltip */ "./node_modules/@nextcloud/vue/dist/Directives/Tooltip.mjs");
/* harmony import */ var _nextcloud_files__WEBPACK_IMPORTED_MODULE_12__ = __webpack_require__(/*! @nextcloud/files */ "./node_modules/@nextcloud/files/dist/index.mjs");
/* harmony import */ var _nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! @nextcloud/initial-state */ "./node_modules/@nextcloud/initial-state/dist/index.mjs");
...
/* harmony import */ var _nextcloud_paths__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @nextcloud/paths */ "./node_modules/@nextcloud/paths/dist/index.mjs");
...
/* harmony import */ var _nextcloud_moment__WEBPACK_IMPORTED_MODULE_18__ = __webpack_require__(/*! @nextcloud/moment */ "./node_modules/@nextcloud/moment/dist/index.mjs");
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ((0,vue__WEBPACK_IMPORTED_MODULE_19__.defineComponent)({
  ...
  components: {
    ...
    NcDateTime: _nextcloud_vue_components_NcDateTime__WEBPACK_IMPORTED_MODULE_9__["default"],
    NcListItem: _nextcloud_vue_components_NcListItem__WEBPACK_IMPORTED_MODULE_10__["default"],
  ...
  directives: {
    tooltip: _nextcloud_vue_directives_Tooltip__WEBPACK_IMPORTED_MODULE_11__["default"]
  },
  props: {
    version: {
      type: Object,
  ...
  data() {
    return {
      ...
      capabilities: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_13__.loadState)('core', 'capabilities', {
        files: {
  ...
  computed: {
    humanReadableSize() {
      return (0,_nextcloud_files__WEBPACK_IMPORTED_MODULE_12__.formatFileSize)(this.version.size);
    },
    versionLabel() {
      const label = this.version.label ?? '';
      if (this.isCurrent) {
        if (label === '') {
          return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_14__.t)('files_versions', 'Current version');
        } else {
          return `${label} (${(0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_14__.t)('files_versions', 'Current version')})`;
        }
      }
      if (this.isFirstVersion && label === '') {
        return (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_14__.t)('files_versions', 'Initial version');
      }
      return label;
    },
    versionHumanExplicitDate() {
      return (0,_nextcloud_moment__WEBPACK_IMPORTED_MODULE_18__["default"])(this.version.mtime).format('LLLL');
    },
    downloadURL() {
      if (this.isCurrent) {
    ...
    hasDeletePermissions() {
      return hasPermission(this.fileInfo.permissions, _nextcloud_files__WEBPACK_IMPORTED_MODULE_12__.Permission.DELETE);
    },
    hasUpdatePermissions() {
      return hasPermission(this.fileInfo.permissions, _nextcloud_files__WEBPACK_IMPORTED_MODULE_12__.Permission.UPDATE);
    },
    isDownloadable() {
      if ((this.fileInfo.permissions & _nextcloud_files__WEBPACK_IMPORTED_MODULE_12__.Permission.READ) === 0) {
        return false;
      }
  ...
  methods: {
    ...
    async fetchDisplayName() {
      ...
      if (this.version.author) {
        try {
          const {
            data
          } = await _nextcloud_axios__WEBPACK_IMPORTED_MODULE_17__["default"].get((0,_nextcloud_router__WEBPACK_IMPORTED_MODULE_16__.generateOcsUrl)(`/cloud/users/${this.version.author}`));
    ...
    t: _nextcloud_l10n__WEBPACK_IMPORTED_MODULE_14__.t
  }
}));
...
/******/ })()
;
//# sourceMappingURL=files_versions-files_versions.js.map?v=821a78e80d48415aa7c1