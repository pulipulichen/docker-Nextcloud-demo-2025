...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = ({
  ...
  data() {
    return {
      ...
      systemTagsCreationRestrictedToAdmin: (0,_nextcloud_initial_state__WEBPACK_IMPORTED_MODULE_0__.loadState)('settings', 'restrictSystemTagsCreationToAdmin', false)
    };
  },
  methods: {
    async updateSystemTagsDefault(isRestricted) {
      try {
        ...
        this.handleResponse({
          errorMessage: (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.t)('settings', 'Unable to update setting'),
          error: e
        });
      }
    },
    handleResponse(_ref) {
      ...
      if (status === 'ok') {
        ...
        (0,_nextcloud_dialogs__WEBPACK_IMPORTED_MODULE_1__.showSuccess)(isRestricted ? (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.t)('settings', 'System tag creation is now restricted to administrators') : (0,_nextcloud_l10n__WEBPACK_IMPORTED_MODULE_2__.t)('settings', 'System tag creation is now allowed for everybody'));
        return;
      }
      if (errorMessage) {
...
var render = function render() {
  ...
  }, [_vm._v("\n\t\t" + _vm._s(_vm.t("settings", "System tag management")) + "\n\t")]), _vm._v(" "), _c("p", {
    staticClass: "settings-hint"
  }, [_vm._v("\n\t\t" + _vm._s(_vm.t("settings", "If enabled, only administrators can create and edit tags. Accounts can still assign and remove them from files.")) + "\n\t")]), _vm._v(" "), _c("NcCheckboxRadioSwitch", {
    attrs: {
      type: "switch",
  ...
  }, [_vm._v("\n\t\t" + _vm._s(_vm.t("settings", "Restrict tag creation and editing to administrators")) + "\n\t")])], 1);
};
var staticRenderFns = [];
render._withStripped = true;
...
/******/ })()
;
//# sourceMappingURL=systemtags-admin.js.map?v=949bcce0be52a1ab29b9