"use strict";
(self["webpackChunknextcloud"] = self["webpackChunknextcloud"] || []).push([["node_modules_nextcloud_upload_dist_chunks_ConflictPicker-Cqb09im7_mjs"],{

/***/ "./node_modules/css-loader/dist/cjs.js!./node_modules/@nextcloud/upload/dist/assets/ConflictPicker-C18pJD_w.css":
/*!**********************************************************************************************************************!*\
  !*** ./node_modules/css-loader/dist/cjs.js!./node_modules/@nextcloud/upload/dist/assets/ConflictPicker-C18pJD_w.css ***!
  \**********************************************************************************************************************/
...
/***/ "./node_modules/@nextcloud/upload/dist/assets/ConflictPicker-C18pJD_w.css":
/*!********************************************************************************!*\
  !*** ./node_modules/@nextcloud/upload/dist/assets/ConflictPicker-C18pJD_w.css ***!
  \********************************************************************************/
...
/* harmony import */ var _css_loader_dist_cjs_js_ConflictPicker_C18pJD_w_css__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! !!../../../../css-loader/dist/cjs.js!./ConflictPicker-C18pJD_w.css */ "./node_modules/css-loader/dist/cjs.js!./node_modules/@nextcloud/upload/dist/assets/ConflictPicker-C18pJD_w.css");
...
var update = _style_loader_dist_runtime_injectStylesIntoStyleTag_js__WEBPACK_IMPORTED_MODULE_0___default()(_css_loader_dist_cjs_js_ConflictPicker_C18pJD_w_css__WEBPACK_IMPORTED_MODULE_6__["default"], options);




       /* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (_css_loader_dist_cjs_js_ConflictPicker_C18pJD_w_css__WEBPACK_IMPORTED_MODULE_6__["default"] && _css_loader_dist_cjs_js_ConflictPicker_C18pJD_w_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals ? _css_loader_dist_cjs_js_ConflictPicker_C18pJD_w_css__WEBPACK_IMPORTED_MODULE_6__["default"].locals : undefined);


/***/ }),

/***/ "./node_modules/@nextcloud/upload/dist/chunks/ConflictPicker-Cqb09im7.mjs":
/*!********************************************************************************!*\
  !*** ./node_modules/@nextcloud/upload/dist/chunks/ConflictPicker-Cqb09im7.mjs ***!
  \********************************************************************************/
...
/* harmony export */ });
/* harmony import */ var _assets_ConflictPicker_C18pJD_w_css__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../assets/ConflictPicker-C18pJD_w.css */ "./node_modules/@nextcloud/upload/dist/assets/ConflictPicker-C18pJD_w.css");
...
/* harmony import */ var _index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./index-DAnggv92.mjs */ "./node_modules/@nextcloud/upload/dist/chunks/index-DAnggv92.mjs");
...
var __component__$5 = /* @__PURE__ */ (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.n)(
  _sfc_main$5,
  _sfc_render$5,
...
var __component__$4 = /* @__PURE__ */ (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.n)(
  _sfc_main$4,
  _sfc_render$4,
...
var __component__$3 = /* @__PURE__ */ (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.n)(
  _sfc_main$3,
  _sfc_render$3,
...
var __component__$2 = /* @__PURE__ */ (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.n)(
  _sfc_main$2,
  _sfc_render$2,
...
const _sfc_main$1 = (0,vue__WEBPACK_IMPORTED_MODULE_9__.defineComponent)({
  ...
  computed: {
    ...
    incomingSize() {
      if (!this.incomingFile) {
        return (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.t)("Unknown size");
      }
  ...
  watch: {
    ...
    incoming: {
      ...
      async handler() {
        ...
        } else if ((0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.a)(this.incoming)) {
  ...
  methods: {
    ...
    isFolder(node) {
      if ((0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.i)(node)) {
    ...
    t: _index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.t
  }
});
...
var __component__$1 = /* @__PURE__ */ (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.n)(
  _sfc_main$1,
  _sfc_render$1,
...
const _sfc_main = (0,vue__WEBPACK_IMPORTED_MODULE_9__.defineComponent)({
  ...
  setup() {
    return {
      blockedTitle: (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.t)("You need to select at least one version of each file to continue.")
    };
  },
  data() {
    return {
  ...
  computed: {
    name() {
      if (this?.dirname?.trim?.() !== "") {
        return (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.b)("{count} file conflict in {dirname}", "{count} file conflicts in {dirname}", this.conflicts.length, {
          count: this.conflicts.length,
          dirname: this.dirname
        });
      }
      return (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.b)("{count} file conflict", "{count} files conflict", this.conflicts.length, { count: this.conflicts.length });
    },
    skipButtonLabel() {
      return (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.b)("Skip this file", "Skip {count} files", this.conflicts.length, { count: this.conflicts.length });
    },
  ...
  mounted() {
    this.files = this.conflicts.map((conflict) => {
      const name = conflict instanceof File || (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.i)(conflict) ? conflict.name : conflict.basename;
    ...
    _index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.l.debug("ConflictPicker initialised", { files: this.files, conflicts: this.conflicts, content: this.content });
  },
  methods: {
    onCancel(error) {
      this.opened = false;
    ...
    onSkip() {
      _index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.l.debug("Conflict skipped. Ignoring all conflicting files");
      this.opened = false;
      this.$emit("submit", {
        selected: [],
        renamed: []
    ...
    onSubmit() {
      ...
      const toRename = this.newSelected.filter((node) => {
        const name = node instanceof File || (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.i)(node) ? node.name : node.basename;
        return selectedOldNames.includes(name);
      });
      if (toRename.length > 0) {
        toRename.forEach((file) => {
          const name = file instanceof File || (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.i)(file) ? file.name : file.basename;
          const newName = (0,_nextcloud_files__WEBPACK_IMPORTED_MODULE_2__.getUniqueName)(name, directoryContent);
          if (file instanceof File || (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.i)(file)) {
      ...
      _index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.l.debug("Conflict resolved", { selected, renamed });
      this.opened = false;
      this.$emit("submit", {
        selected,
        renamed
    ...
    onSelectAllNew(selected) {
      if (selected) {
        _index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.l.debug("Selected all new files");
        this.newSelected = this.conflicts;
      } else {
        _index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.l.debug("Cleared new selection");
        this.newSelected = [];
      }
    },
    onSelectAllOld(selected) {
      if (selected) {
        _index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.l.debug("Selected all existing files");
        this.oldSelected = this.files;
      } else {
        _index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.l.debug("Cleared old selection");
        this.oldSelected = [];
      }
    },
    t: _index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.t
...
var __component__ = /* @__PURE__ */ (0,_index_DAnggv92_mjs__WEBPACK_IMPORTED_MODULE_3__.n)(
  _sfc_main,
  _sfc_render,
...
//# sourceMappingURL=node_modules_nextcloud_upload_dist_chunks_ConflictPicker-Cqb09im7_mjs-node_modules_nextcloud_upload_dist_chunks_ConflictPicker-Cqb09im7_mjs.js.map?v=0cb7af51536d64b7f8ae