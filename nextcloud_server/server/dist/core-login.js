...
var render = function render() {
  ...
  }, [_vm._v("\n\t\t\t\t\t" + _vm._s(_vm.t("core", "Guest Link")) + "\n\t\t\t\t")])], 1) : !_vm.loading && _vm.passwordlessLogin ? _c("div", {
    key: "reset-pw-less",
